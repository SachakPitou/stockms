    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                //     ->modalHeading('Submit for Verification')
                //     ->modalDescription('This sends your request to HR Staff for review. You cannot edit it after submitting.')
                ...
                //             ->body('HR Staff will review and verify your request.')
                //             ->success()
                //             ->send();
                //     }),

                // ── B: Verify (HR Staff only — cannot approve) ────────
                ...
                // ── C: Approve and prompt to create PO ───────────────
                Tables\Actions\Action::make('approve')
                    ...
                    ->action(function (PurchaseRequest $record, array $data) {
                        ...
                        $po = PurchaseOrder::create([
                            ...
                            'warehouse_id'               => $mainWarehouse->id,          // always receive at Main
                            'destination_warehouse_id'   => $record->warehouse_id,        // where it's ultimately needed
                            'user_id'                    => auth()->id(),
                            'status'                     => 'draft',
